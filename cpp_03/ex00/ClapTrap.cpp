...
/*   Updated: 2023/07/18 11:50:19 by lpaulo-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &target)
{
	if (this->is_dead())
	{
		std::cout << "ClapTrap " + this->name + " has died and can't attack." << std::endl;
		return;
	}

	if (this->is_tired())
	{
		std::cout << "ClapTrap " + this->name + " ran out of energy and can't attack." << std::endl;
		return;
	}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->is_dead())
	{
		std::cout << "ClapTrap " + this->name + " has died and can't take any more damage." << std::endl;
		return;
	}

	this->hit_points -= amount;
	std::cout
		<< "ClapTrap " + this->name + " takes " << amount << " points of damage!"
		<< std::endl;
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->is_dead())
	{
		std::cout << "ClapTrap " + this->name + " has died and can't be repaired." << std::endl;
		return;
	}

	if (this->is_tired())
	{
		std::cout << "ClapTrap " + this->name + " ran out of energy and can't be repaired." << std::endl;
		return;
	}
	...
	this->hit_points += amount;
	std::cout
		<< "ClapTrap " + this->name + " recovers " << amount << " points of damage!"
		<< std::endl;
}
